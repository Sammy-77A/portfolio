            ...
            <div className="tools-grid reveal">
              <div className="tool-item">
                <div className="tool-icon" style={{ background: '#4F5B93' }}>
                  <svg width="34" height="34" viewBox="0 0 24 24" fill="white"><path d="M7.01 10.207h-.944l-.515 2.648h.838c.556 0 .97-.105 1.242-.314.272-.21.455-.559.55-1.049.092-.47.05-.802-.124-.995-.175-.193-.523-.29-1.047-.29zM12 5.688C5.373 5.688 0 8.514 0 12s5.373 6.313 12 6.313S24 15.486 24 12c0-3.486-5.373-6.312-12-6.312zm-3.26 7.451c-.261.25-.575.438-.917.551-.336.108-.765.164-1.285.164H5.357l-.327 1.681H3.652l1.23-6.326h2.65c.797 0 1.378.209 1.744.628.366.418.476 1.002.33 1.752a2.836 2.836 0 0 1-.305.847c-.143.255-.33.49-.561.703zm4.024.715l.543-2.799c.063-.318.039-.536-.068-.651-.107-.116-.336-.174-.687-.174H11.46l-.704 3.625H9.388l1.23-6.327h1.367l-.327 1.682h1.218c.767 0 1.295.134 1.586.401s.378.7.263 1.299l-.572 2.944h-1.389zm7.597-2.265a2.782 2.782 0 0 1-.305.847c-.143.255-.33.49-.561.703a2.44 2.44 0 0 1-.917.551c-.336.108-.765.164-1.286.164h-1.18l-.327 1.682h-1.378l1.23-6.326h2.649c.797 0 1.378.209 1.744.628.366.417.477 1.001.331 1.751zM17.766 10.207h-.943l-.516 2.648h.838c.557 0 .971-.105 1.242-.314.272-.21.455-.559.551-1.049.092-.47.049-.802-.125-.995s-.524-.29-1.047-.29z"/></svg>
                </div>
                <div>
              ...
              <div className="tool-item">
                <div className="tool-icon" style={{ background: '#b07219' }}>
                  <svg width="28" height="28" viewBox="0 0 448 512" fill="white"><path d="M273.6 273.6c-50 0-76.4 5.5-111.4 15.5-31.8 9.5-62.7 18.6-118.6 18.6v33.2c56.8 0 88.6-9.1 119.5-19.1 35-10 61.4-15.5 110.5-15.5v-32.7zm116.8 28.2c-47.3 0-71.8 6.4-105.9 15.5-30 8.2-59.5 16.4-110 16.4v33.2c51.4 0 81.4-8.2 110.5-16.4 33.6-9.1 57.7-15.5 105.5-15.5v-33.2zm-26.8 64.1c-43.2 0-66.4 7.3-98.2 15.5-28.6 8.2-56.8 15.5-103.6 15.5v33.2c48.2 0 76.4-7.3 104.5-15.5 32.3-8.2 55.5-15.5 97.3-15.5v-33.2zm-200.5-98.6c43.6 0 67.3-7.3 99.1-15.5 28.6-8.2 56.4-15.5 104.1-15.5V203c-48.6 0-75.9 7.3-104.5 15.5-32.3 8.2-55 15.5-98.6 15.5v33.3zM357.7 0c-43.2 0-66.8 7.3-98.6 15.5-28.6 8.2-56.4 15.5-103.6 15.5v33.2c48.6 0 76.4-7.3 104.5-15.5 32.3-8.2 55.5-15.5 97.7-15.5V0zm-42.3 133.2c44.1 0 68.6-8.2 101.4-16.4 28.2-7.3 54.1-13.6 96.8-13.6V69.5c-44.5 0-69.5 6.4-102.3 14.5-27.7 7.3-53.6 13.6-95.9 13.6v35.6zm79.1 268.2c-52.7 0-93.6 7.3-125.9 20.9-20.9 9.1-36.4 20-45.5 32.7-5 7.3-7.3 15.5-7.3 23.6 0 25.5 19.5 45.5 56.4 56.4 34.1 10.9 79.5 16.4 135 16.4 83.2 0 148.6-13.6 186.8-39.1 25.5-17.3 39.5-39.1 39.5-63.2 0-21.8-11.4-40.9-32.3-54.5-40-25.7-111-33.2-206.7-33.2zM218.6 448.2c9.5-7.3 22.7-12.7 38.6-17.3 30-8.2 73.2-12.7 125-12.7 87.7 0 151.4 6.4 185 18.2 16.8 6.4 26.8 13.6 26.8 21.8 0 8.2-10 16.4-28.6 22.7-35.5 12.7-99.1 19.1-182.7 19.1-71.8 0-120.9-5.5-144.5-15.5-10-4.5-15.5-9.1-15.5-13.6.1-9 \ 5.4-16.3 15.9-22.7z"/></svg>
                </div>
                <div>
              ...
              <div className="tool-item">
                <div className="tool-icon" style={{ background: '#006600' }}>
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"></rect><path d="M12 18h.01"></path><path d="M9 8l1.5 3L12 8l1.5 3L15 8"></path></svg>
                </div>
                <div>
